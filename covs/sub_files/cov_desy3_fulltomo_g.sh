...
for ((i = 0; i < SLURM_NTASKS; i++)); do
	...
	srun --ntasks 1 --exclusive -c 1 ./cov ${i_cov} ini_files/cov_desy3_fulltomo_g.ini >&/home/c.c1025819/CosmoCov-itrharrison/covs/log_files/cov_desy3_fulltomo_g_${i_cov}.log
done;
